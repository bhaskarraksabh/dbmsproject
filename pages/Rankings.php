...
$(document).mouseup(function(e){
    ...
    if(!container.is(e.target) && container.has(e.target).length === 0){
        container.hide();
                ...
                <div class="content-app">
                    <div class="ivu-row-flex ivu-row-flex-space-around" data-v-ed093576="">
                        <div class="ivu-col ivu-col-span-22" data-v-ed093576="">
                            <div class="ivu-card ivu-card-bordered"data-v-ed093576="">
                            <div class="ivu-table-wrapper" data-v-ed093576="">
                                <div class="ivu-table-large">
                                    <div class="ivu-table-header">
                                        <table style="width:1129px;" cellspacing="0" cellpadding="0" border="0">
                                    <colgroup>
                                <col width="60">
                                <col width="178">
                                <col width="178">
 ...
 $query="SELECT * FROM Users ORDER BY Solved DESC";
$result=mysqli_query($link,$query) or die("query error");
$num=1;
                        while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                        {
                                echo '<tbody class="ivu-table-tbody">';
                                    echo '<tr clas="ivu-table-row">';
                                       echo '<td class="ivu-table-column-center">';
