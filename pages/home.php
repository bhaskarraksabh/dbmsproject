    ...
    if(!container.is(e.target) && container.has(e.target).length === 0){
        container.hide();
                ...
                <div class="content-app">
                    <div class="container" data-v-5d6fd9be="">
                        <div class="ivu-card ivu-card-bordered" data-v-5d6fd9be="">
                <div class="ivu-card-body" style="padding:100px;">
                <div data-v-5d6fd9be="">
                    <p data-v-5d6fd9be="" style="margin-top:-10px;">
                <span class="emphasis" data-v-5d6fd9be="">
                    <?php
                ...
                <hr id="split" data-v-5d6fd9be="">
                <div class="flex-container" data-v-5d6fd9be="">
            <div class="left" data-v-5d6fd9be="">
                <p data-v-5d6fd9be="">
                    Solved
                </p>
                <p class="emphasis" data-v-5d6fd9be="">
                    <?php
                    $var=$_SESSION['username'];
                    $link=mysqli_connect('localhost','root','','Project') or die("database error");
                    $query="SELECT * FROM Users where user_name='$var'";
            ...
            <div class="middle" data-v-5d6fd9be="">
            <p data-v-5d6fd9be="">
                    Submissions
                </p>
                <p class="emphasis" data-v-5d6fd9be="">
            ...
            <div class="right" data-v-5d6fd9be="">
            <p data-v-5d6fd9be="">
                    Score
                </p>
                <p class="emphasis" data-v-5d6fd9be="">
